...
class AppServiceProvider extends ServiceProvider
{
    ...
    private function registerForInMemory()
    {
        ...
        $this->app->bind(UserCreatePresenterInterface::class, UserCreatePresenter::class);
    }
    ...
    {
        $this->app->bind(\packages\UseCase\User\GetList\UserGetListUseCaseInterface::class, \packages\MockInteractor\User\MockUserGetInteractor::class);
        $this->app->bind(UserGetListPresenterInterface::class, UserGetListPresenter::class);
        $this->app->bind(\packages\UseCase\User\Create\UserCreateUseCaseInterface::class, \packages\MockInteractor\User\MockUserCreateInteractor::class);
        $this->app->bind(UserCreatePresenterInterface::class, UserCreatePresenter::class);
    }
}
